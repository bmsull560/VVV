...
class ValueDriverAgent(CalculationAgent):
    def __init__(self, agent_definition_path: str, mcp_client: MCPClient, config: Dict[str, Any]):
        ...
        agent_id = self.definition.get('agent_id', 'value_driver')
    ...
    async def execute(self, inputs: Dict[str, Any]) -> AgentResult:
        ...
        result = {"economic_value": 120000, "drivers": ["Cost savings", "Productivity"]}
